...
folder are mapped to the application's root namespace, 'senchaCmdTest'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "senchaCmdTest"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'senchaCmdTest' in the same way
as `"senchaCmdTest/sass/src"`.
